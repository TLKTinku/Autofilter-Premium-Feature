...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'My_Movies_files') # Collection name (default: dreamcinezone_files)
...
BACKUP_CHANNEL_LINK = environ.get('BACKUP_CHANNEL_LINK', GRP_LNK) # Backup channel link, used for the clickable Name in file captions
