...
API_ID = int(environ.get('API_ID', '39102296')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '0c005baa4b2ad3ee47573b1b3540b7f1')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8965361396:AAEl9oaAnoeLS5vC22eAV_s4i6tm9R1aeF0")    # Bot token from @BotFather
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004449691573'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1004406835584'))  # Bin channel id (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://<tlktinkubro_db_user>:gkgDpWdErTiZxd32@cluster0.1e3s4b5.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'TLK_files') # Collection name (default: dreamcinezone_files)
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'TLKfiles'))
MULTI_CLIENT = False
name = str(environ.get('name', 'My Movies Offical'))
